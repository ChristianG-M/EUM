...
class serverConnSSHSendPy():
	def __init__(self):
		pass


	def sendPy(self, ip, user, password, pathFrom, pathTo, file):
		try:
...
def main():
	try:
		...
		file = 'inServer.py'
		newSendConf = serverConnSSHSendPy()
		newSendConf.sendPy(ip, user, password, pathFrom, pathTo, file)
